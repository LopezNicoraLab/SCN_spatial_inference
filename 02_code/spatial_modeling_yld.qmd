...
ggsave("results/fig_1.tiff",units="in", width=7, height=9,bg = "white")
...
yield <- ggplot(dat1, aes(y = row, x = col, z = yield_dev)) +
  ...
  scale_fill_manual(
    values = cc, 
    name = expression(atop("Seed yield deviation", paste("(kg ", ha^{-1}, ")"))),
    drop = FALSE
  ) +
  facet_grid(~year) +
...
ggsave("results/fig_2.tiff", units = "in", width = 6, height = 5.5, bg = "white")
...
ggsave("results/fig_4.tiff", units = "in", width = 7, height = 6, bg = "white")
